...
[![golangci-lint](https://github.com/caesar-data/go-twitter/actions/workflows/golangci-lint.yml/badge.svg)](https://github.com/caesar-data/go-twitter/actions/workflows/golangci-lint.yml)
[![go-test](https://github.com/caesar-data/go-twitter/actions/workflows/go-test.yml/badge.svg)](https://github.com/caesar-data/go-twitter/actions/workflows/go-test.yml)
...
This [project](https://github.com/caesar-data/go-twitter/projects/1) will track the process of this initial version.

```
go get -u github.com/caesar-data/go-twitter/v2
```
...
import (
	...
	twitter "github.com/caesar-data/go-twitter/v2"
)
